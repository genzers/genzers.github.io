		...
		<div class="container">
			<div class="row">
				<div class="dropdown">
					<nav class="menu">
						...
						<div class="dropdown-content">
						  ...
						  <a href="#" onclick="return false;" onmousedown="autoScrollTo('div2');">Contact Us</a>
						  <a href="#">Testimony</a>
						</div>
					</nav>
				</div>
				...
				<div class="dropdown">
					<nav class="menu">
						<ul>
							<li><a href="http://genzers.nctu.me/genzers.github.io/subwebsites/events/events.html" style="font-size:20px;" >events</a>
							</li>
						</ul>
						<div class="dropdown-content">
